-- A'qua D'or comprehensive system implementation (Part 3 - JSON Fixed)
...
-- Drop and recreate children table with new structure
...
-- Insert default admin configuration with proper JSON
...
DROP TRIGGER IF EXISTS trigger_set_profile_qr_code ON public.profiles;
