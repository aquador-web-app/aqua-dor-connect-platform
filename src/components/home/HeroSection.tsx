  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/src/assets/pool-hero-background.jpg')`,
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button 
            size="lg" 
            variant="outline" 
            className="text-base sm:text-lg px-8 py-3 bg-transparent border-white/20 text-white hover:bg-white/10 hover:border-white hover:backdrop-blur-sm"
            asChild
          >
