  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        if (roleError || !roleData || !['admin', 'co_admin'].includes(roleData.role)) {
      ...
      <div className="container flex items-center justify-center min-h-[calc(100vh-80px)] py-8">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            ...
            <CardTitle className="text-2xl text-center">Portail Administrateur</CardTitle>
